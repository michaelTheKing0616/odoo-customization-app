...
- [x] GEN2-13 Draft #6 punch list + scorecard hardening: A1–A6 apply-readiness fixes (empty arch fields, live `x_company_id`, strip branch-manager USER rules, dedupe line parent m2o, `build_depth_block`, line-menu/sequence/search polish); B1–B5 `ai_draft_validators.py` + score caps + wizard chip; fixture `draft_supermarket6_2026-08-08.json`; gate artifact `docs/research/gen2_13_run_2026-08-08.json` score **9.82** validators green (fixture6 replay)
