...
def upgrade() -> None:
    ...
    op.create_index("ix_trust_anomaly_events_connection_id", "trust_anomaly_events", ["connection_id"])
    op.create_index("ix_trust_anomaly_events_workspace_id", "trust_anomaly_events", ["workspace_id"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_connection_mutation_hourly_hour_bucket", table_name="connection_mutation_hourly")
    op.drop_index("ix_connection_mutation_hourly_connection_id", table_name="connection_mutation_hourly")
