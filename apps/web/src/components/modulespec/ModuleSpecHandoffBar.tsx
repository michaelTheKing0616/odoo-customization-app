  ...
  return (
    <Card className="p-5" data-testid="modulespec-handoff-bar">
      ...
      <p className="mt-1 text-sm text-muted">
        ModuleSpec is the IR. Draft Studio authors it. View Designer edits live forms.
        Job Autopilot is the sandbox done-bar — not Completeness 10.0. Promote stays human.
      </p>
